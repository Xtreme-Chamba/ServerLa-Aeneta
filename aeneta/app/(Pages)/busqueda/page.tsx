"use client";
import Pagination from "@/app/Components/busqueda/paginacion";
import Search from "@/app/Components/busqueda/barraBusqueda";
import Table from "@/app/Components/busqueda/tabla";
    ...
    try {
      const fetchGetPaginas = async () => {
        const response = await fetch(
          `http://localhost:4000/busqueda/paginas/${campo}`,
          {
            method: "POST",
            headers: {
