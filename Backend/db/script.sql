...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `busqueda_anio_puntual_sencilla`( anio_busqueda INT )
BEGIN
	SELECT * FROM aeneta.metadatos_detallados_documento
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `busqueda_anio_rango_secilla`(anio_inicio int, anio_final int)
BEGIN
	SELECT * FROM aeneta.metadatos_detallados_documento
	where anio >= anio_inicio and anio <= anio_final;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `busqueda_autor_sencilla`( cadena_busqueda text )
BEGIN
	SELECT * FROM aeneta.metadatos_detallados_documento
	where INSTR(CONCAT_WS(" ", Nombres, Apellidos), cadena_busqueda) > 0;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `busqueda_titulo_sencilla`( cadena_busqueda text)
BEGIN
	SELECT * FROM aeneta.metadatos_detallados_documento
	where INSTR(titulo, cadena_busqueda) > 0;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2024-04-13 18:55:40
